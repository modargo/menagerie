...
import menagerie.powers.HydraHeadsPower;

public class Hydra extends CustomMonster
{
    public static final String ID = "Menagerie:Hydra";
    ...
    private static final int TAIL_WHIP_DAMAGE = 3;
    ...
    private static final int HP_MIN = 81;
    private static final int HP_MAX = 85;
    private static final int A8_HP_MIN = 83;
    private static final int A8_HP_MAX = 87;
    ...
    static {
        ...
        NAME = Hydra.monsterStrings.NAME;
        MOVES = Hydra.monsterStrings.MOVES;
    }
}