...
public class WhisperingWraith extends CustomMonster
{
    public static final String ID = "Menagerie:WhisperingWraith";
    ...
    private static final int FADE_AWAY_DAMAGE = 10;
    private static final int A2_FADE_AWAY_DAMAGE = 11;
    private static final int GHOSTLY_TOUCH_DAMAGE = 6;
    private static final int A2_GHOSTLY_TOUCH_DAMAGE = 7;
    ...
    static {
        ...
        NAME = WhisperingWraith.monsterStrings.NAME;
        MOVES = WhisperingWraith.monsterStrings.MOVES;
        DIALOG = WhisperingWraith.monsterStrings.DIALOG;
    }
}