...
public class WhisperingWraith extends CustomMonster
{
    ...
    private static final int FADE_AWAY_DAMAGE = 9;
    private static final int A2_FADE_AWAY_DAMAGE = 10;
    private static final int GHOSTLY_TOUCH_DAMAGE = 5;
    private static final int A2_GHOSTLY_TOUCH_DAMAGE = 6;
