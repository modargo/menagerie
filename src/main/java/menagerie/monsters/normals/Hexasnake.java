...
import menagerie.powers.SerpentsGazePower;

public class Hexasnake extends CustomMonster {
    public static final String ID = "Menagerie:Hexasnake";
    ...
    private static final int CONSTRICT_AMOUNT = 1;
    private static final int A17_CONSTRICT_AMOUNT = 2;
    ...
    static {
        ...
        NAME = Hexasnake.monsterStrings.NAME;
        MOVES = Hexasnake.monsterStrings.MOVES;
    }
}