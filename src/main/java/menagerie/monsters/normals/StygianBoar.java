...
public class StygianBoar extends CustomMonster
{
    public static final String ID = "Menagerie:StygianBoar";
    ...
    private static final int BREATHE_FIRE_DAMAGE = 5;
    private static final int A2_BREATHE_FIRE_DAMAGE = 6;
    ...
    static {
        ...
        NAME = StygianBoar.monsterStrings.NAME;
        MOVES = StygianBoar.monsterStrings.MOVES;
    }
}