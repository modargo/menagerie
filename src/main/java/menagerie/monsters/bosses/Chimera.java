...
public class Chimera extends CustomMonster
{
    ...
    private static final int TRIPLE_BITE_DAMAGE = 5;
    private static final int A4_TRIPLE_BITE_DAMAGE = 6;
    ...
    private static final int CLAW_AND_HORN_DAMAGE = 12;
    private static final int A4_CLAW_AND_HORN_DAMAGE = 14;
    private static final int CLAW_AND_HORN_BLOCK = 5;
    private static final int A9_CLAW_AND_HORN_BLOCK = 7;
    private static final int VENOM_SPIT_DAMAGE = 9;
    private static final int A4_VENOM_SPIT_DAMAGE = 11;
